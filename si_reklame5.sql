...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Nov 2019 pada 23.39
...
('PT. Boy Arista', 12, 'mataram', 'mataram', 12, 12, '3', '493848', '12345', 6, '8438498', 'perusahaan_12345.png');
...
(51, 1234, 6, 3, 4, 'lunas', 'lunas', '2019-08-09', '2019-11-09', 0),
...
(9, 12345, 6, 23, 7, 'belum di bayar', 'belum di bayar', '2019-09-12', '2021-08-12', 0);
...
('admin', '1234', 'mataram', '0033-12-12', 'mataram', 'mataram', 12, 12, 'admin', '3', '3232', 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'user_1234.png'),
('boy', '12345', 'mataram', '0229-12-31', 'mataram', 'mataram', 12, 12, 'mataram', '3', '2222', 'user', 'boy', '21232f297a57a5a743894a0e4a801fc3', 'user_12345.png'),
('contoh', '439420', 'contoh', '2019-11-01', 'mataram', 'mataram', 12, 32, '53059', '4', '40394', 'user', 'contoh', '21232f297a57a5a743894a0e4a801fc3', 'user_439420.png');
...
--
ALTER TABLE `kecamatan`
  MODIFY `id_kecamatan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
