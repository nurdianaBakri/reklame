...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2019 at 12:06 PM
...
--
-- Table structure for table `jenis_reklame`
--
...
--
-- Dumping data for table `jenis_reklame`
--
...
--
-- Table structure for table `lokasi_jalan`
--
...
--
-- Dumping data for table `lokasi_jalan`
--
...
--
-- Table structure for table `sudut_pandang`
--
...
--
-- Dumping data for table `sudut_pandang`
--
...
--
-- Indexes for table `jenis_reklame`
--
...
--
-- Indexes for table `lokasi_jalan`
--
...
--
-- Indexes for table `sudut_pandang`
--
...
--
-- AUTO_INCREMENT for table `jenis_reklame`
--
ALTER TABLE `jenis_reklame`
...
--
-- AUTO_INCREMENT for table `lokasi_jalan`
--
ALTER TABLE `lokasi_jalan`
...
--
-- AUTO_INCREMENT for table `sudut_pandang`
--
ALTER TABLE `sudut_pandang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
